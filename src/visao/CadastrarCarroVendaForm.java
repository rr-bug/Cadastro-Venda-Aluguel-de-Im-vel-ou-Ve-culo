 ...
 * @author Rayana
 */
public class CadastrarCarroVendaForm extends javax.swing.JInternalFrame 
{
    /**
     * Atributo empresa
     */
     ...
     * Construtor padrão
     */
    public CadastrarCarroVendaForm() 
    {
        initComponents();
    }
     ...
     * @param empresa -
     */
    public CadastrarCarroVendaForm(Empresa empresa) 
    {
        initComponents();
    ...
    private void initComponents() {
        ...
        cadastrarTreinador.setText("Cadastrar Carro Venda");
    ...
    /**
     * Método de cadastrar carro venda
     * @param evt -
     */
    private void cadastrarTreinadorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cadastrarTreinadorActionPerformed
        CarroVenda carroVenda = (CarroVenda) empresa.getFactory().gerarProduto("carrovenda");
        ...
        else
        {
            ...
            carroVenda.setValorVenda(variavelDouble);
            carroVenda.setCodigo(empresa.getProdutos().size()+1);
            variavelTexto = descricao.getText();
            carroVenda.setDescricao(variavelTexto);
            variavelTexto = foto.getText();
            carroVenda.setFoto(variavelTexto);
            variavelTexto = ano.getText();
            variavelInt = Integer.parseInt(variavelTexto);
            carroVenda.setAno(variavelInt);
            variavelTexto = nPassageiros.getText();
            variavelInt = Integer.parseInt(variavelTexto);
            carroVenda.setNumeroPassageiros(variavelInt);
            variavelTexto = categoria.getText();
            carroVenda.setCategoria(variavelTexto);

            if(empresa.adicionaProduto(carroVenda))
            {
